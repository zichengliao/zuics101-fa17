...
\begin{frame}
  ...
  \Enlarge
  \begin{itemize}
  \myitem  \texttt{go.illinois.edu/cs101} \pause
  \myitem  Register your i>clickers on the course Compass page (only). \pause
  \mysubitem  Will send notice today of registration. \pause
  \myitem  Complete Homework \#1 before Wednesday at 6:00 p.m. \pause
  \mysubitem  Only Homework \#1!  (\#2--\#6 will be later.) \pause
  \mysubitem  Final answer counts. \pause
  \mysubitem  You \emph{do} have to buy access to complete the homework. \pause
  \mysubitem  If having trouble, use campus computer lab. \pause
...
\begin{frame}
  ...
  \Enlarge
  \begin{itemize}
  \myitem  Lab \#2 this week, no lab next week (Labor Day). \pause
  \myitem  Exam dates posted on course website. \pause
  \myitem  Where can you get help in this class?
    \begin{itemize}
    \mysubitem  Piazza forum (allow 24 hours)
    \mysubitem  TAs in labs and office hours (soon)
    \end{itemize} \pause

...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \myitem instruction is the lowest level machine code %\& smallest units of computation
    \myitem instructions are encoded in binary
    \myitem 8-bit binary: a byte
...
\begin{frame}[fragile]
  ...
  \begin{center}
    a hypothesis about the nature of \emph{computable} functions \\ \vspace{2mm}
